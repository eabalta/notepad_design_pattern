...
// NotepadCreator adli metod, icerisine bir factory alarak make islemleri gerceklestirir.
...
public class Notepad  implements  ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        String s = e.getActionCommand();  // yukarıda ekledigimiz actionlistener'lar burada alınıyor
        Search search = Search.getInstance();  // Search,replace işlemleri için Search nesnesi tanımlandı
        Words words = Words.getInstance();      //Kontrol için nesne tanımlandı.
        IslemYap islem = new IslemYap();        //Dosya işlemleri strategy paternine göre yapıldı. Hepsi benzer işlemler yaptığı için DosyaInterface arayüzünden türeyen bi IslemYap nesnesi olusturuldu
                                                //Sadece içerisinde islem yap olan ve bu fonksiyonda DosyaInterface tipinden islem alan bi fonksiyon tanımlandı
                                                //Bu işlemler için IslemYap turunden bi nesne oluşturuldu

        if (s.equals("New")) {
            islem.islemYap(new DosyaOlustur());   //islemYap metodunun icerisinde DosyaOlustur turunden DosyaInterface işlemi gönderildi.
        } else if (s.equals("Open")) {
            islem.islemYap(new DosyaAc());          //islemYap metodunun icerisinde DosyaAc turunden DosyaInterface işlemi gönderildi.
        } else if (s.equals("Exit")) {
            islem.islemYap(new DosyaKapat());       //islemYap metodunun icerisinde DosyaKapat turunden DosyaInterface işlemi gönderildi.
        } else if (s.equals("Save")) {
            islem.islemYap(new DosyaKaydet());      //islemYap metodunun icerisinde DosyaKaydet turunden DosyaInterface işlemi gönderildi.
